 ...
 */
 //kpr($plugin->view);
 if($plugin->view->name == 'calendar_items_calendar'){
 	 $nav_title = date('F Y', strtotime($nav_title));
 	 $nav_title = 'Calendar of Events'.'<br>'."<span id='calendar_subheader'>$nav_title</span>";
 }
